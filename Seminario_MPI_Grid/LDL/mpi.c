...
int main(int argc, char *argv[]){
    ...
    double time_start, time_end, ts2, te2;
    double time_sending_data, time_s_r_procesing, time_procesing, time_recovering_data;
