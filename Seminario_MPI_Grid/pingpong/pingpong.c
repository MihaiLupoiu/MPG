...
int main(int argc, char **argv)
{
	...
	int buffer5[SIZE5], buffer6[SIZE6], buffer7[SIZE7], buffer8[SIZE8];
	MPI_Status estado;
...
void obtener_info_sist()
{
	...
	printf("## Original Program Author: Gonzalo Sanchez \n");
	printf("## GitHub: https://github.com/sanchezg/mpi-pingpong \n");
	printf("## Modified Program Author: Mihai Lupoiu \n");
	printf("## GitHub: https://github.com/MihaiLupoiu/mpi-pingpong \n");
	printf("\n");
}
